...
from mlops_final_exercise.utils import show_image_and_target
...
def dataset_statistics(datadir: str = "data/processed") -> None:
    ...
    plt.xlabel("Label")
    plt.ylabel("Count")
    plt.savefig("images/train_label_distribution.png")
    plt.close()
    ...
    plt.xlabel("Label")
    plt.ylabel("Count")
    plt.savefig("images/test_label_distribution.png")
    plt.close()
